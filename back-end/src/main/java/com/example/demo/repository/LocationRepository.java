...
public interface LocationRepository extends JpaRepository<Location, Integer> {
    ...
    @Query(value = "select * from location where user_id=?1 and created_at between  date_add(now(),interval -14 day) and now();",nativeQuery = true)
    public List<Location> getLocationsByUserIdAndCreated_atBetweenBy2Weeks(String uid);
