...
function Today() {
    ...
    const arrays = [
        {
            id: 0,
            site: "https://search.naver.com/search.naver?where=nexearch&sm=top_sug.pre&fbm=1&acr=1&acq=%EC%BD%94%EB%A1%9C%EB%82%98&qdt=0&ie=utf8&query=%EC%BD%94%EB%A1%9C%EB%82%98+%ED%99%95%EC%A7%84%EC%9E%90",
            names: "해외"
        },
        ...
        {
            id: 3,
            site: "https://www.gb.go.kr/Main/open_contents/section/wel/page.do?mnu_uid=5857&LARGE_CODE=360&MEDIUM_CODE=90&SMALL_CODE=10&mnu_order=2",
            names: "경북"
        },
        {id: 4, site: "https://www.jeonnam.go.kr/coronaMainPage.do", names: "전남"},
        {
            id: 5,
            site: "https://www.jeonbuk.go.kr/board/list.jeonbuk?boardId=BBS_0000105&menuCd=DOM_000000110001000000&contentsSid=1219&cpath=",
            names: "전북"
        },
        {id: 6, site: "http://www.chungnam.go.kr/coronaStatus.do", names: "충남"},
        {
            id: 7,
            site: "https://search.naver.com/p/crd/rd?m=1&px=154&py=1048&sx=154&sy=648&p=U8W5xlprvTVsssM%2BStRssssstOh-058750&q=%EC%BD%94%EB%A1%9C%EB%82%98+%ED%99%95%EC%A7%84%EC%9E%90&ie=utf8&rev=1&ssc=tab.nx.all&f=nexearch&w=nexearch&s=2DQLf%2FxYMpHkSMrF7QvgMg%3D%3D&time=1607158941407&bt=29&a=nco_xxe*1&r=1&i=80202lh0_000000D39981&u=http%3A%2F%2Fwww1.chungbuk.go.kr%2Fcovid-19%2Findex.do&cr=1",
            names: "충북"
        },
        {id: 8, site: "http://www.provin.gangwon.kr/covid-19.html", names: "강원"},
        {
            id: 9,
            site: "https://search.naver.com/p/crd/rd?m=1&px=164&py=837&sx=164&sy=437&p=U8W5xlprvTVsssM%2BStRssssstOh-058750&q=%EC%BD%94%EB%A1%9C%EB%82%98+%ED%99%95%EC%A7%84%EC%9E%90&ie=utf8&rev=1&ssc=tab.nx.all&f=nexearch&w=nexearch&s=2DQLf%2FxYMpHkSMrF7QvgMg%3D%3D&time=1607158967027&bt=29&a=nco_xxe*1&r=1&i=80202lh0_000000D39981&u=https%3A%2F%2Fwww.gg.go.kr%2Fbbs%2FboardView.do%3FbsIdx%3D464%26bIdx%3D2296956%26menuId%3D1535&cr=1",
            names: "경기"
        },
        {
            id: 10,
            site: "https://www.sejong.go.kr/bbs/R3273/list.do;jsessionid=GjeH5aBxfimtiCVnZldl5gWBveGmhXSKRdxmswBPK3Q9LX3oVgaZG5xxQZgZePEQ.Portal_WAS1_servlet_engine5?cmsNoStr=17465",
            names: "세종"
        },
        {id: 11, site: "https://www.ulsan.go.kr/corona.jsp", names: "울산"},
        {
            id: 12,
            site: "https://search.naver.com/p/crd/rd?m=1&px=154&py=915&sx=154&sy=515&p=U8W5xlprvTVsssM%2BStRssssstOh-058750&q=%EC%BD%94%EB%A1%9C%EB%82%98+%ED%99%95%EC%A7%84%EC%9E%90&ie=utf8&rev=1&ssc=tab.nx.all&f=nexearch&w=nexearch&s=2DQLf%2FxYMpHkSMrF7QvgMg%3D%3D&time=1607159001347&bt=29&a=nco_xxe*1&r=1&i=80202lh0_000000D39981&u=https%3A%2F%2Fwww.daejeon.go.kr%2Fcorona19%2Findex.do&cr=1",
            names: "대전"
        },
                                ...
                                <TableBody>
                                    {arrays.map(array => (
                                        <TableRow>
                                            ...
                                            <TableCell>{users[array.id].incDec - users[array.id + 19].incDec > 0 ?
                                                <h5 style={{color: "red"}}>{users[array.id].incDec - users[array.id + 19].incDec}▲</h5> :
                                                <h5 style={{color: "blue"}}>{users[array.id].incDec - users[array.id + 19].incDec}▼</h5>}</TableCell>
                                            <TableCell>
                                                <a target="_blank" href={array.site}>{array.names}홈페이지</a>
                                            </TableCell>
                                        </TableRow>
                                    ))}
                                </TableBody>
